...
## Windows app
Run `release/ROM PolyBot-Setup-2.33.0.exe`, then open ROM PolyBot.
...
## Verification
The full 1,995-test Python suite completes. The 23 Electron script-arming checks pass, and
