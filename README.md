...
| `scripts/` | `site.py` (stage and check), `make_shots.py` (screenshot → PNG + WebP), `make_og.py` + `og-card.html` (social card). |
...
3. The checksum files and `assets/RELEASE-<version>.md`.
