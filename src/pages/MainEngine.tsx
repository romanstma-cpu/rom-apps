  ...
  return (
    ...
    >
      ...
      <details className="mb-5 rounded-xl border border-rom-border p-5">
        ...
        <p className="mt-2 text-xs text-rom-dim">Live quotes must have a spread of 3 cents or less and cannot move more than 2 cents above the signal. New Whale and Momentum sources start at 25% live size and priority until settled practice evidence qualifies them; qualified positive sources are considered first when capital is scarce. Marginal qualifying books are also downsized by spread, movement, fees and visible depth. Practice fills include date-specific US taker fees. These checks improve execution discipline; they do not predict profits.</p>
      </details>
      <details className="mb-5 rounded-xl border border-rom-border p-5">
